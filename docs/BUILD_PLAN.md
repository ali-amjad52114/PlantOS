...
> **Implementation status:** App lives at **repo root** (Next.js). See [`PLANTOS_STATUS.md`](PLANTOS_STATUS.md), [`../README.md`](../README.md), and [`DEMO_JOURNEY.md`](DEMO_JOURNEY.md). Controlling lock: [`PRODUCT_LOCK.md`](PRODUCT_LOCK.md).
