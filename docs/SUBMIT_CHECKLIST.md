...
## Done in-repo
- [x] Controlling product lock (`docs/PRODUCT_LOCK.md`)
- [x] Status board with proof (`docs/PLANTOS_STATUS.md`)
- [x] App runbook (`README.md` at repo root)
- [x] Demo journey doc (`docs/DEMO_JOURNEY.md`)
...
- [x] App at repo root (Vercel Root Directory = `.`)
...
- [ ] Push public GitHub repo (omit `.env`, secrets, large raw CSV if needed — document download)
- [ ] Optional: `npx trigger.dev@4.5.6 deploy` for cloud workers
- [ ] Optional: deploy Next to Vercel with env vars (Root Directory blank / `.`)
